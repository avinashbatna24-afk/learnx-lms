...
const CreateCourse = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect to the new Course Builder page
      navigate(`/instructor/courses/${res.data.data.id}/build`);
    } catch (err) {
  ...
  return (
    <div className="form-container card mx-auto mt-4" style={{ maxWidth: '600px' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="btn primary-btn btn-lg w-100 mt-4" disabled={loading}>
